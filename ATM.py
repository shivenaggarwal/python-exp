...
client = pymongo.MongoClient("mongodb+srv://2021a1r112:MoNKzCvjxJUC0YJs@cluster0.mxwjlnd.mongodb.net/?retryWrites=true&w=majority")
# Database name
...
def send_email(subject, message, to_email):
    from_email = "kumudkesar9858@gmail.com"
    app_password = "hgqv rpjz zzyu nkps"  # generate from app password option in two step verification
